                        ...
                        if (
                            (a("<span>")
                                ...
                                .append(
                                    ...
                                    a("<a>", { href: "#", title: "Removing tag", text: "x" }).click(function () {
                            ...
                            g.push(d),
                            a("#" + f + "_tag").val(""),
                            e.focus ? a("#" + f + "_tag").focus() : a("#" + f + "_tag").blur(),
            ...
            return (
                this.each(function () {
                    if ("undefined" == typeof a(this).attr("data-tagsinput-init")) {
                        ...
                        if (
                            //(f.interactive && (i = i + '<input id="' + e + '_tag" value="" data-default="' + f.defaultText + '" />'),
                            (f.interactive && (i = i + '<textarea id="' + e + '_tag" value="" data-default="' + f.defaultText + '" />'),
                            ...
                            "" != a(h.real_input).val() && a.fn.tagsInput.importTags(a(h.real_input), a(h.real_input).val()),
                            f.interactive)
                        ) {
                            if (
                                ...
                                a(h.fake_input).bind("focus", h, function (b) {
                                    ...
                                    a(b.data.fake_input).val() == a(b.data.fake_input).attr("data-default") && a(b.data.fake_input).val(""), a(b.data.fake_input).addClass("tagsinput-fakeinput-color");
                                }),
                                ...
                                void 0 !== jQuery.Autocompleter
                                    ? (a(h.fake_input).autocomplete(f.autocomplete_url, f.autocomplete),
                                    ...
                                    : void 0 !== jQuery.ui.autocomplete &&
                                      ...
                                      a(h.fake_input).bind("autocompleteselect", h, function (b, c) {
                                ...
                                a(h.fake_input).bind("blur", h, function (b) {
                                    ...
                                    return (
                                        "" != a(b.data.fake_input).val() && a(b.data.fake_input).val() != c
                                            ? b.data.minChars <= a(b.data.fake_input).val().length &&
                                              (!b.data.maxChars || b.data.maxChars >= a(b.data.fake_input).val().length) &&
                                              a(b.data.real_input).addTag(a(b.data.fake_input).val(), { focus: !0, unique: f.unique })
